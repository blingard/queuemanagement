...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Queueing:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('Queueing:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
